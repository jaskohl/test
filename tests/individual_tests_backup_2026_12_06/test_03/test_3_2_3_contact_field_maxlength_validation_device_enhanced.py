"""
Test 3.2.3: Contact Field Maximum Length Validation - Device Enhanced
Purpose: Verify contact field maxlength validation behavior with comprehensive device-aware validation
...
def test_3_2_3_contact_field_maxlength_validation_device_enhanced(
    ...
    print(f"\n=== Device-Enhanced Contact Maxlength Validation Test ===")
    ...
    print(
        f"Test Purpose: Validate contact field maxlength behavior with device awareness"
    )
    ...
    try:
        ...
        print(f"\n=== Device-Enhanced Contact Maxlength Validation COMPLETED ===")
        ...
        print(f"\n Device-Enhanced Contact Maxlength Validation FAILED")
        print(f"Device: {device_model} (Series {device_series})")
        print(f"Field: {field_name}")
        print(f"Error: {str(e)}")
        ...
        raise Exception(
            f"Device-Enhanced Contact Maxlength Validation failed on device {device_model} "
