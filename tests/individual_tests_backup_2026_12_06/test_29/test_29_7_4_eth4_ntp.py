...
def test_29_7_4_eth4_ntp(unlocked_config_page: Page, base_url: str, device_series: str):
    """
    Test 29.7.4: eth4 NTP Configuration
    ...
    if ntp.is_visible(timeout=2000):
