...
def test_29_4_1_eth1_redundancy(
    ...
    # Locate and test eth1 redundancy field
    ...
    if redundancy.is_visible():
        ...
        print(" eth1 redundancy field is enabled with available options")
    else:
        print("eth1 redundancy field not visible (expected on some configurations)")
