"""
Test: 30.2.1 - SNMP Trap Community String Configuration (Device Enhanced)
...
def test_30_2_1_trap_community_configuration_device_enhanced(
    ...
    if trap_community.count() > 0:
        ...
        # ENHANCED: Verify field is editable with device-aware validation
        ...
        try:
            ...
            # ENHANCED: Save with device-aware timeout
