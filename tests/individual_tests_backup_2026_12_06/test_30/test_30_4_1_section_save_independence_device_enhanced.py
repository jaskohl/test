"""
Test: 30.4.1 - SNMP Sections Save Independently (Device Enhanced)
...
def test_30_4_1_section_save_independence_device_enhanced(
    ...
    try:
        # ENHANCED: Get device-aware save button locators
        save1_locator = None
        save2_locator = None
        save3_locator = None
        ...
        # ENHANCED: Only v1/v2c save button should enable (device-aware timeout)
