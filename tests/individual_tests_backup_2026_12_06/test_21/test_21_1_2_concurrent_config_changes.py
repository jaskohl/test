"""
Test 21.1.2: Concurrent Config Changes
...
def test_21_1_2_concurrent_config_changes(browser, base_url: str, device_password: str):
    ...
    for page in [page1, page2]:
        ...
        configure_btn = page.locator("a[title*='locked']").filter(has_text="Configure")
