"""
Test 31 4 1 Protocol Url Generation Validation Never (Device Enhanced)
...
ENHANCED: DeviceCapabilities integration with device-aware protocol validation
"""
...
def test_31_4_1_protocol_url_generation_validation_never_device_enhanced(
    base_url: str, request
):
    """
    Test 31.4.1: Protocol URL Generation Validation - NEVER Mode (Device Enhanced)
    ...
    ENHANCED: DeviceCapabilities integration with device-aware validation
    """
    ...
    try:
        ...
        # ENHANCED: Cross-validate protocol logic with DeviceCapabilities
        ...
        # ENHANCED: Validate protocol requirements per enforcement mode with device context
        logger.info(
        ...
        # ENHANCED: Test protocol determination logic for NEVER mode with device validation
        assert (
        ...
        # ENHANCED: Verify URL could be constructed properly (device-aware validation)
        ...
        # ENHANCED: Basic URL structure validation with device context
        assert (
            "://" in dashboard_url
