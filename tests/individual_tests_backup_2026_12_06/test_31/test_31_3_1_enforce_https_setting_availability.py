"""
Test 31 3 1 Enforce Https Setting Availability
...
def test_31_3_1_enforce_https_setting_availability(
    access_config_page,
    device_capabilities: dict,
):
    """
    Test 31.3.1: HTTPS Enforcement Setting Availability
    ...
    try:
        ...
        pytest.fail(f"HTTPS enforcement setting availability test failed: {e}")
