...
Enforce HTTPS Mode Dashboard Never - DeviceCapabilities Enhanced
Test Count: 1 of 6 in Category 31
Hardware: Device Only
Priority: HIGH - Security configuration
Series: Both Series 2 and 3
ENHANCED: Comprehensive DeviceCapabilities integration for device-aware HTTPS validation
"""
...
def test_31_1_1_enforce_https_mode_dashboard_never_device_enhanced(
    access_config_page: AccessConfigPage, base_url: str, request
):
    """
    Test 31.1.1: Enforce HTTPS Mode Dashboard Never - DeviceCapabilities Enhanced
    ...
    ENHANCED: Full DeviceCapabilities integration for HTTPS enforcement validation
