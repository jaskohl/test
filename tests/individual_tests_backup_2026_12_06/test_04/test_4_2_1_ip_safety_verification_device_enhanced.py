...
def test_4_2_1_ip_safety_verification_device_enhanced(
    ...
    try:
        ...
        # Get current static IP for safety verification
        current_ip = network_config_page.get_current_ip()
        if current_ip:
        ...
        # Test DHCP mode without changing actual network settings
        ...
        # Safe rollback - restore original mode without changing IPs
