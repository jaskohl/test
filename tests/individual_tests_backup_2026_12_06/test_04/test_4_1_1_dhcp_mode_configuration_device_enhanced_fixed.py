...
FIXED: Now uses correct device-enhanced page object imports
"""
...
def test_4_1_1_dhcp_mode_configuration_device_enhanced(
    ...
    FIXED: Using device-enhanced page object with correct imports
    """
    ...
    try:
        ...
        network_config_page.configure_dhcp_mode()
        ...
        # Restore original network mode safely - FIXED: Use get_page_data instead of non-existent get_current_mode
        try:
