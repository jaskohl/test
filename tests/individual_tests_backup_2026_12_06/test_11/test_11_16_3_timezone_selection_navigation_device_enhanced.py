"""
Test 11.16.3: Timezone Selection Navigation (Device-Enhanced)
Category 11: Form Validation Tests
Test Count: 3 of 47 total tests (Device-Enhanced Version)
...
def test_11_16_3_timezone_selection_navigation_device_enhanced(
    general_config_page: GeneralConfigPage,
    request,
    base_url: str,
):
    """
    Test 11.16.3: Timezone dropdown navigation and selection (Device-Enhanced)
    ...
    Device-Enhanced: Uses device model and series for model-specific navigation patterns
    """
    ...
    try:
        ...
        if str(device_series) == "3":
            # Series 3 devices may have enhanced timezone features
            timezone_selectors = [
