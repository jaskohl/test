"""
Test 11.18.2: Feature Availability Validation (Device-Enhanced)
...
Device-Enhanced: Full DeviceCapabilities integration with series-specific feature validation
...
def test_11_18_2_feature_availability_validation_device_enhanced(
