"""
Test 11.17.2: Output Frequency Validation (Device-Enhanced)
...
Device-Enhanced: Uses DeviceCapabilities for model-specific validation patterns
"""
...
def test_11_17_2_output_frequency_validation_device_enhanced(
