...
Session Expiry Modal Triggers - DeviceCapabilities Enhanced
Test Count: 1 of 2 in Category 32
Hardware: Device Only
Priority: MEDIUM - Session management
Series: Both Series 2 and 3
ENHANCED: Comprehensive DeviceCapabilities integration for device-aware session validation
"""
...
def test_32_1_1_session_expiry_modal_triggers_device_enhanced(
    logged_in_page: Page, base_url: str, request
):
    """
    Test 32.1.1: Session Expiry Modal Triggers - DeviceCapabilities Enhanced
    ...
    ENHANCED: Full DeviceCapabilities integration for session management validation
