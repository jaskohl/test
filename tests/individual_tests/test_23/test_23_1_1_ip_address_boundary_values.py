"""
Test 23.1.1: IP address boundary values (Device )
Category 23 - Boundary & Input Testing
Test Count: 3 tests
Hardware: Device Only
Priority: MEDIUM
Series: Both Series 2 and 3
 with DeviceCapabilities Integration

Extracted from: tests/test_23_boundary.py
Source Class: TestBoundaryValues
 with full DeviceCapabilities integration patterns
"""
...
def test_23_1_1_ip_address_boundary_values(
    ...
    """
    Test 23.1.1: IP address field boundary values (Device )
    ...
    try:
        ...
        pytest.fail(
            f"Device- IP boundary test failed on {device_hardware_model}: {str(e)}"
        )
...
def test_23_1_2_numeric_field_boundaries(
    ...
    """
    Test 23.1.2: Numeric field boundary values (Device )
    ...
    try:
        ...
        pytest.fail(
            f"Device- numeric boundary test failed on {device_hardware_model}: {str(e)}"
        )
...
def test_23_1_3_text_field_length_limits(
    ...
    """
    Test 23.1.3: Text field length limits (Device )
    ...
    try:
        ...
        pytest.fail(
            f"Device- text field length test failed on {device_hardware_model}: {str(e)}"
        )
