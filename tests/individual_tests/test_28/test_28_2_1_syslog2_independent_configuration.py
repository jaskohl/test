"""
Test 28.2.1: Second Syslog Target Independent Configuration [DEVICE ]
Category: 28 - Syslog Configuration Tests
Test Count: Part of 11 tests in Category 28
Hardware: Device Only
Priority: HIGH
Series: Both Series 2 and 3
: DeviceCapabilities integration for device-aware syslog validation
: Series-specific multi-syslog target validation patterns
: Device-aware timeout scaling and independent configuration testing
...
def test_28_2_1_syslog2_independent_configuration(
    ...
    : DeviceCapabilities integration for series-specific syslog validation
