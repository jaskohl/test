...
Syslog 1 Enable Checkbox - DeviceCapabilities
Test Count: 1 of 1 in Category 28
Hardware: Device Only
Priority: HIGH - Syslog configuration functionality
Series: Both Series 2 and 3
: Comprehensive DeviceCapabilities integration for device-aware syslog validation
"""
...
def test_28_1_1_syslog1_enable_checkbox(
    ...
    """
    Test 28.1.1: Syslog 1 Enable Checkbox - DeviceCapabilities
    ...
    : Full DeviceCapabilities integration for syslog configuration validation
