"""
Test 25.1.4: Negative UTC offset handling [DEVICE ]
...
: Series-specific negative offset validation patterns
: Device-aware timeout scaling and timezone capability validation
