"""
Test 25.1.1: Leap second handling in time configuration [DEVICE ]
Category: 25 - Time Synchronization Edge Cases
Test Count: Part of 5 tests in Category 25
Hardware: Device Only
Priority: MEDIUM
Series: Both Series 2 and 3
: DeviceCapabilities integration for device-aware validation
: Cross-validation with device database for GNSS capabilities
: Device-aware timeout scaling and series-specific validation
...
def test_25_1_1_leap_second_handling(
    ...
    : DeviceCapabilities integration for series-specific GNSS validation
