"""
Test 25.1.3: DST transition handling [DEVICE ]
Category 25: Time Synchronization Edge Cases - COMPLETE
Test Count: Part of 5 tests in Category 25
Hardware: Device Only
Priority: MEDIUM
Series: Both Series 2 and 3
: DeviceCapabilities integration for device-aware timezone validation
: Series-specific DST configuration validation
: Device-aware timeout scaling and field detection patterns
...
def test_25_1_3_dst_transition_handling(
    ...
    : DeviceCapabilities integration for series-specific timezone validation
    ...
    if dst_rule and dst_rule.is_visible(timeout=timeout_scaled):
        ...
        #  DST NONE option detection with device-aware patterns
