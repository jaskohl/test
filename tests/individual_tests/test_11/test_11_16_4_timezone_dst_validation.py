"""
Test 11.16.4: Timezone DST Validation (Device-)
Category 11: Form Validation Tests
Test Count: 4 of 47 total tests (Device- Version)
...
def test_11_16_4_timezone_dst_validation(
    ...
    Device-: Uses device model and series for model-specific DST validation
    """
    ...
    try:
        ...
        if str(device_series) == "3":
            # Series 3 devices may have  DST features
            dst_selectors = [
                "input[name*='dst' i]",
                "select[name*='dst' i]",
