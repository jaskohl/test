"""
Test 31.2.1: HTTPS Enforcement Mode Configuration and Config Access - NEVER Mode [DEVICE ]
...
: DeviceCapabilities integration for device-aware HTTPS validation
: Series-specific HTTPS enforcement validation patterns
: Device-aware timeout scaling and comprehensive HTTPS testing

Extracted from: tests/test_31_https_enforcement_scenarios.py
Source Class: TestHTTPSEnforcementScenarios
: 2025-12-01 with DeviceCapabilities integration
"""
...
def test_31_2_1_enforce_https_mode_and_verify_config_access_never(
    ...
    : DeviceCapabilities integration for series-specific HTTPS validation
    ...
    # : Use DeviceCapabilities for series validation instead of fixture
    if device_series != 3:
    ...
    try:
        ...
        # : Configure HTTPS enforcement with device-aware timeout
        ...
        # : Save configuration with device-aware timeout
        ...
        # : Wait for configuration to take effect with device-aware timing
        ...
        # : Extract device IP from base_url for protocol testing
        device_ip = (
        ...
        try:
            ...
            # : Device-aware error handling for HTTPS navigation
