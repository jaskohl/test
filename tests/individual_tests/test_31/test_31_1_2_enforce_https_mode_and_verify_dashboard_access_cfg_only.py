"""
Test 31 1 2 Enforce Https Mode And Verify Dashboard Access Cfg Only (Device )
...
def test_31_1_2_enforce_https_mode_and_verify_dashboard_access_cfg_only(
    ...
    """
    Test 31.1.2: HTTPS Enforcement Mode Configuration and Dashboard Access - CFG_ONLY Mode (Device )
    ...
    try:
        ...
        try:
            ...
            # : Device-aware validation of protocol enforcement
            actual_protocol = (
                "https"
