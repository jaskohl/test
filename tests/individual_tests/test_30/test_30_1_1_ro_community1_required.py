...
RO Community 1 Required Field - DeviceCapabilities
Test Count: 1 of 3 in Category 30
Hardware: Device Only
Priority: HIGH - SNMP configuration functionality
Series: Both Series 2 and 3
: Comprehensive DeviceCapabilities integration for device-aware SNMP validation
"""
...
def test_30_1_1_ro_community1_required(
    ...
    """
    Test 30.1.1: RO Community 1 Required Field - DeviceCapabilities
    ...
    : Full DeviceCapabilities integration for SNMP configuration validation
