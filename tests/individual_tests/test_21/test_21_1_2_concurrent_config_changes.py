"""
Test 21.1.2: Concurrent Config Changes (Device-)
...
Based on COMPLETE_TEST_LIST.md Section 21
 ...
 Version with DeviceCapabilities Integration
"""
...
def test_21_1_2_concurrent_config_changes(browser, base_url: str, request):
    ...
    print(f"\n=== Device- Concurrent Config Changes Test ===")
