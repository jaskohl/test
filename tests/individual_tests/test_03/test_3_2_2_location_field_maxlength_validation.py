"""
Test 3.2.2: Location Field Maximum Length Validation - Pure Page Object Pattern
...
def test_3_2_2_location_field_maxlength_validation(
    ...
    Purpose: Verify location field maxlength validation behavior using pure page object methods
    ...
    print(f"\n=== Pure Page Object Location Maxlength Validation Test ===")
    ...
    print(
        f"Test Purpose: Validate location field maxlength behavior with pure page objects"
    )
    ...
    try:
        ...
        print(f"\n=== Pure Page Object Location Maxlength Validation COMPLETED ===")
        ...
        print(f"\n Pure Page Object Location Maxlength Validation FAILED")
        print(f"Device: {device_model} (Series {device_series})")
        print(f"Field: {field_name}")
        print(f"Error: {str(e)}")
        ...
        raise Exception(
            f"Pure Page Object Location Maxlength Validation failed on device {device_model} "
